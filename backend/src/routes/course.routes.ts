...
router.post("/:courseId/enroll", authenticate, authorize(["student"]), enrollStudent);
router.delete("/:courseId/disenroll", authenticate, authorize(["student"]), disenrollStudent);
router.put("/:id", authenticate, authorize(["admin", "lecturer"]), updateCourse);
