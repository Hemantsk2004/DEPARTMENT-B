...
router.post("/:courseId/enroll", auth_middleware_1.authenticate, (0, auth_middleware_1.authorize)(["student"]), course_controller_1.enrollStudent);
router.delete("/:courseId/disenroll", auth_middleware_1.authenticate, (0, auth_middleware_1.authorize)(["student"]), course_controller_1.disenrollStudent);
