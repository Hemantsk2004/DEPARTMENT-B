...
router.post("/:courseId", auth_middleware_1.authenticate, (0, auth_middleware_1.authorize)(["lecturer", "admin"]), // Fix: admin can upload too
uploadMiddleware_1.default.single("file"), material_controller_1.uploadMaterial);
